...
if ($user_id) {
    $reference = $database->getReference('users_table/' . $user_id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['operation']) && $_POST['operation'] === 'status_update') {
        ...
        $_SESSION['message'] = "User status updated to " . ucfirst($status) . ".";
                                            ...
                                            <div class="card-body">
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label"><b>Date of birth:</b>  <?= htmlspecialchars($user['date_of_birth']) ?></label>
...
<!-- <?php if (isset($user)): ?>
        <div class="card">
            <div class="card-body">
                 <?php if ($user['profile_picture']): ?>
                    <img src="<?= htmlspecialchars($user['profile_picture']) ?>" alt="Profile Picture" class="img-fluid"> <br> <br>
                <?php endif; ?>
                ...
                <p class="card-text"><strong>Date of Birth:</strong> <?= htmlspecialchars($user['date']) ?></p>
    ...
    <?php endif; ?>
    <a href="user.php" class="btn btn-primary mt-3">Back to Users</a>
</div> -->
