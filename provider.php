...
// Handle deletion
if (isset($_GET['confirmDeleteUser']) && isset($_GET['id'])) {
    $Id = $_GET['id'];

    $sql = "DELETE FROM users_patients WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['message'] = "Error deleting user record: " . $stmt->error;
...
// Retrieve only users with accountType 'user'
$sql = "SELECT id, firstname, lastname, email, phone FROM users_patients WHERE accountType = 'provider'";
    ...
    window.onload = function() {
                                ...
                                <div class="card ">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box d-flex align-items-center justify-content-between">
                                            <h4 class="mb-0">Provider Management</h4> 
                                            <a href="providerAccount.php"><button class="btn btn-green" style="background-color:#8dc741;color:white">Add Provider</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <tbody>
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td><a href="providerDetails.php?id=<?php echo $user['id']; ?>" class="btn btn-primary btn-sm">Details</a></td>
                    <td><a href="editProvider.php?id=<?php echo $user['id']; ?>" class="btn btn-orange btn-sm">Edit</a></td>
                    <td><button onclick="showConfirmation('delete', <?php echo $user['id']; ?>)" class="btn btn-danger btn-sm delete-btn">Delete</button></td>
        ...
        <script>
            function showConfirmation(type, id) {
                var message =  'Are you sure you want to delete this provider?' ;
            ...
            function deleteRecord() {
                ...
                window.location.href = 'provider.php?confirmDeleteProvider=true&id=' + id;
