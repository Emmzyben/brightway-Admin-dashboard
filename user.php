...
if ($fetchdata) {
    foreach ($fetchdata as $key => $value) {
        if (isset($value['accountType']) && $value['accountType'] === 'user') {
            $users[] = [
                'id' => $key,
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                          ...
                          <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                              <li class="active"><a href="user.php" >Overview</a></li>
                                ...
                                <div class="card ">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box d-flex align-items-center justify-content-between">
                                            <h4 class="mb-0" style="color: rgba(0, 0, 0, 0.664);">User overview</h4>
                                           <a href="account.php"><button class="btn btn-green" style="background-color:#8dc741;color:white">Add User</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <tbody>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td><a href="userDetails.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-primary btn-sm">Details</a></td>
                <td><a href="editUser.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-orange btn-sm">Edit</a></td>
...
<script>
    ...
    function deleteRecord() {
        ...
        window.location.href = 'user.php?confirmDeleteUser=true&id=' + encodeURIComponent(id);
    }
</script>
