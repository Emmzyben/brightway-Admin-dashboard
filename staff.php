...
// Handle deletion
if (isset($_GET['confirmDeleteStaff']) && isset($_GET['id'])) {
    $id = $_GET['id'];
     
    $ref_table = 'users_table/' . $id; 
    ...
    if ($deleteResult) {
        ...
        $_SESSION['message'] = "Error deleting staff record.";
...
if ($fetchdata) {
    foreach ($fetchdata as $key => $value) {
        if (isset($value['accountType']) && $value['accountType'] === 'staff') {
            $users[] = [
                'id' => $key,
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                          ...
                          <li class="treeview active">
                            <a href="javascript:void(0)"><i class="bx bx-file"></i><span>Staff</span>
                              <i class="fa fa-angle-right"></i></a>
                            <ul class="treeview-menu">
                              <li class="active"><a href="staff.php">Overview</a></li>
                                ...
                                <div class="card ">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="staffaccount.php"><button class="btn btn-green" style="background-color:#8dc741;color:white">Add Staff</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <tbody>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td><a href="staffDetails.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-primary btn-sm">Details</a></td>
                <td><a href="editStaff.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-orange btn-sm">Edit</a></td>
...
<script>
    function showConfirmation(type, id) {
        var message = 'Are you sure you want to delete this staff?';
    ...
    function deleteRecord() {
        ...
        window.location.href = 'staff.php?confirmDeleteStaff=true&id=' + encodeURIComponent(id);
    }
</script>
