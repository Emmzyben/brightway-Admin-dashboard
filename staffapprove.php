...
if ($allUsers) {
    foreach ($allUsers as $userId => $user) {
        ...
        if (in_array($user['approved'], ['unapproved', 'declined']) && $user['accountType'] === 'staff') {
...
<nav>
                                ...
                                <div class="card">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box ">
                                            <h4 class="mb-0">Approve Staff</h4>
    ...
    <?php foreach ($filteredUsers as $user): ?>
        <div style="margin: 15px;">
            <a href="staffDetails.php?id=<?= htmlspecialchars($user['id'], ENT_QUOTES, 'UTF-8') ?>" style="text-decoration: none; color: inherit;">
