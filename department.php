...
// Handle deletion
if (isset($_GET['confirmDeleteDepartment']) && isset($_GET['id'])) {
    $id = $_GET['id'];

    $ref_table = 'department/' . $id; 
    $deleteResult = $database->getReference($ref_table)->remove();

    if ($deleteResult) {
        $_SESSION['message'] = "Department record deleted successfully.";
    ...
    window.onload = function() {
                                ...
                                <div class="card ">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box d-flex align-items-center justify-content-between">
                                            <h4 class="mb-0">Dapartment Management</h4>
                                            <a href="departmentaccount.php"><button class="btn btn-green" style="background-color:#8dc741;color:white">Add Department</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <?php foreach ($users as $user): ?>
            <tr>
              ...
              <td><a href="editDepartment.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-orange btn-sm">Edit</a></td>
...
<script>
    ...
    function deleteRecord() {
        ...
        window.location.href = 'department.php?confirmDeleteDepartment=true&id=' + encodeURIComponent(id);
    }
</script>
                    </div>
                </div>
