...
if (isset($_POST['addStaff'])) {
    ...
    if ($postRef_result) {
        ...
        $_SESSION['message'] = "Error registering staff";
        $_SESSION['messageType'] = 'error';
        header("Location: staffaccount.php");
        exit;
    }
...
<nav>
    ...
    <div class="row">
        ...
        <div class="mb-3 account">
                            <label for="email-name" class="col-form-label">Department:</label>
                <select class="form-select account w-100" name="department"  required>
...
<script>
    ...
    <div class="card">
        <div class="card-header-cu">
            <h6 class="mb-0">Set Staff Login</h6>
        </div>
        <div class="card-body">
            <div class="mb-3">
            ...
            <div class="col-12 mt-2">
                <button type="submit" class="btn btn-primary" name='addStaff'>Create staff</button>
            </div>
        </div>
    </div>
</form>
