...
if ($allUsers) {
    foreach ($allUsers as $userId => $user) {
        ...
        if (in_array($user['approved'], ['unapproved', 'declined']) && $user['accountType'] === 'user') {
...
<nav>
                        <ul class="sidebar-menu" data-widget="tree">
                          ...
                          <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                              ...
                              <li class="active"><a href="approve.php" >Approve users</a></li>
                            </ul>
                          </li>
                          <li class="treeview">
                                ...
                                <div class="card">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box ">
                                            <h4 class="mb-0">Approve Users</h4>
    ...
    <?php foreach ($filteredUsers as $user): ?>
        <div style="margin: 15px;">
            <a href="userDetails.php?id=<?= htmlspecialchars($user['id'], ENT_QUOTES, 'UTF-8') ?>" style="text-decoration: none; color: inherit;">
