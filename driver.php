...
// Handle deletion
if (isset($_GET['confirmDeleteDriver']) && isset($_GET['id'])) {
    $id = $_GET['id'];
    ...
    if ($deleteResult) {
        $_SESSION['message'] = "Driver record deleted successfully.";
        $_SESSION['messageType'] = 'success';
    } else {
        $_SESSION['message'] = "Error deleting driver record.";
...
if ($fetchdata) {
    foreach ($fetchdata as $key => $value) {
        if (isset($value['accountType']) && $value['accountType'] === 'driver') {
            $users[] = [
                'id' => $key,
                                ...
                                <div class="card ">
                                    <div class="card-body card-breadcrumb">
                                        <div class="page-title-box d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="driveraccount.php"><button class="btn btn-green" style="background-color:#8dc741;color:white">Add Driver</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <tbody>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td><a href="driverDetails.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-primary btn-sm">Details</a></td>
                <td><a href="editDriver.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-orange btn-sm">Edit</a></td>
...
<script>
    function showConfirmation(type, id) {
        var message = 'Are you sure you want to delete this driver?';
    ...
    function deleteRecord() {
        ...
        window.location.href = 'driver.php?confirmDeleteDriver=true&id=' + encodeURIComponent(id);
    }
</script>
